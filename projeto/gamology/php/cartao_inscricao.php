...
<html>
    ...
    <body>
        ...
        <main class="container">
           ...
           <h2><?php echo "Parabens por se inscrever  " . $_SESSION['nickname_usuario']; ?></h2>
           <div class="conteudo" style="margin-top: 85px;">
                ...
                <form id="print" class="card">
                    <div class="card-body">
                        ...
                        <h2 style="margin-top: 10px;">Torneio de alguma coisa/2018</h2>
                        ...
                        <p>Número da inscrição:<br/><?= $row['id_usuario'] ?></p>
                        <p>Nome completo:<br/><?= $row['nome_usuario'] ?></p>
                        <p>Nickname:<br/><?= $row['nickname_usuario'] ?></p>
            ...
            <a href="../html/index.html"><button style="margin-top: 20px;" type="submit" class="btn btn-outline-primary">Voltar à página inicial</button></a>
